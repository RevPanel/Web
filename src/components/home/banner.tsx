...
export default function Banner() {
  return (
    <div className="my-4 flex w-full justify-center px-8">
      <div className="relative flex flex-col items-center justify-center gap-2 rounded-xl bg-background-secondary p-8 py-14 text-center md:h-96 md:w-4/5 md:p-4 md:py-4">
        <Image
          src="/dots.svg"
