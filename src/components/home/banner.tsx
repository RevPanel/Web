...
export default function Banner() {
  return (
    <div className="my-4 relative md:w-4/5 md:h-96 p-8 py-14 md:py-4 md:p-4 mx-auto bg-background-secondary rounded-xl flex flex-col gap-2 justify-center items-center text-center">
      <Image
        src="/dots.svg"
      ...
      <LinkButton
        href="#"
        role="white"
        className="font-medium uppercase !p-4 !px-8"
      >
